...
TEST_CASE("ScaleView::CalculateTickMarks", "[scale_view]")
{
    ...
    SECTION("generates tick marks at 200 Hz intervals for 2048 transform size")
    {
        ...
        CHECK(have.size() == 110);
        CHECK(have.at(0) == ScaleView::TickMark{ 9, {} });         // 200 Hz
        CHECK(have.at(1) == ScaleView::TickMark{ 18, {} });        // 400 Hz
        CHECK(have.at(2) == ScaleView::TickMark{ 27, {} });        // 600 Hz
        CHECK(have.at(3) == ScaleView::TickMark{ 37, {} });        // 800 Hz
        CHECK(have.at(4) == ScaleView::TickMark{ 46, 1000 });      // 1000 Hz
        CHECK(have.at(5) == ScaleView::TickMark{ 55, {} });        // 1200 Hz
        CHECK(have.at(107) == ScaleView::TickMark{ 1003, {} });    // 21600 Hz
        CHECK(have.at(108) == ScaleView::TickMark{ 1012, {} });    // 21800 Hz
        CHECK(have.at(109) == ScaleView::TickMark{ 1021, 22000 }); // 22000 Hz
    }
    ...
    SECTION("generates tick marks at 100 Hz intervals for 4096 transform size")
    {
        ...
        const auto have = view.CalculateTickMarks(1024);
        CHECK(have.size() == 110);
        CHECK(have.at(0) == ScaleView::TickMark{ 9, {} });         // 100 Hz
        CHECK(have.at(1) == ScaleView::TickMark{ 18, {} });        // 200 Hz
        CHECK(have.at(2) == ScaleView::TickMark{ 27, {} });        // 300 Hz
        CHECK(have.at(3) == ScaleView::TickMark{ 37, {} });        // 400 Hz
        CHECK(have.at(4) == ScaleView::TickMark{ 46, 500 });       // 500 Hz
        CHECK(have.at(5) == ScaleView::TickMark{ 55, {} });        // 600 Hz
        CHECK(have.at(107) == ScaleView::TickMark{ 1003, {} });    // 10800 Hz
        CHECK(have.at(108) == ScaleView::TickMark{ 1012, {} });    // 10900 Hz
        CHECK(have.at(109) == ScaleView::TickMark{ 1021, 11000 }); // 11000 Hz
    }
